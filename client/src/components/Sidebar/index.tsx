  ...
  return (
    <div className={sidebarClassName}>
        <div className='flex h-[100%] w-full flex-col justify-start'>
            <div className='z-50 flex min-h-[56] w-64 items-center bg-white px-6 pt-3 dark:bg-black'>
            ...
            className='flex w-full items-center justify-between px-8 text-gray-500'>
